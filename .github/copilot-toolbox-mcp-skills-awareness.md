...
_Generated: 2026-04-02T16:33:59.087Z_
...
Workspace `mcp.json` _(folder: scankart final prooject 3.0)_

- **e:\scankart\scankart final prooject 3.0\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\kumar\AppData\Roaming\Code\User\mcp.json** — _File missing_
